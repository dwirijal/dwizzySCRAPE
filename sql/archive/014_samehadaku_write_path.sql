CREATE OR REPLACE VIEW public.anime_catalog_sync_view AS
SELECT
...
CREATE OR REPLACE VIEW public.anime_detail_ready_view AS
SELECT a.slug
FROM public.anime_list a
...
CREATE OR REPLACE VIEW public.anime_stream_ready_view AS
...
CREATE OR REPLACE FUNCTION public.upsert_samehadaku_catalog(payload jsonb)
RETURNS integer
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION public.upsert_samehadaku_anime_detail(payload jsonb)
RETURNS integer
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION public.upsert_samehadaku_episode(payload jsonb)
RETURNS integer
LANGUAGE plpgsql
AS $$
DECLARE
