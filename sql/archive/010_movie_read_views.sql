CREATE OR REPLACE VIEW public.movie_list_view AS
SELECT
    tmdb_id,
    slug,
    title,
...
CREATE OR REPLACE VIEW public.movie_detail_view AS
SELECT
    m.tmdb_id,
    m.slug,
    m.title,
...
CREATE OR REPLACE VIEW public.movie_watch_summary_view AS
SELECT
    m.tmdb_id,
    m.slug,
    m.title,
